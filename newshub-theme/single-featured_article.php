<?php
/**
 * Single Featured Article Template
 *
 * @package NewsHub
 */
            ...
            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                <header class="single-post-header">
                    ...
                    if (function_exists('get_field')) {
                        ...
                        echo '<div class="featured-badge"><span>' . esc_html($badge_text) . '</span></div>';
                    }
                    ?>
                    ...
                    <div class="single-post-meta">
                        ...
                        <?php endif; ?>
                        <?php if (function_exists('get_field') && get_field('featured_priority')) : ?>
                            <span class="priority">
                                <?php _e('Priority:', 'newshub'); ?> <?php echo get_field('featured_priority'); ?>/10
                            </span>
                        <?php endif; ?>
                    </div>
